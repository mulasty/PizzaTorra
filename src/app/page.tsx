    ...
    <main className={styles.page}>
      ...
      <section className={styles.socialSection}>
        <div className={styles.socialSectionInner}>
          <p className={styles.sectionEyebrow}>Social media</p>
          <h2 className={styles.sectionTitle}>Zapraszamy do odwiedzin naszych social mediów</h2>
          <p className={styles.sectionText}>
            Śledź nas na Facebooku, aby być na bieżąco z nowościami, promocjami i wydarzeniami w TORRA.
          </p>
          <a
